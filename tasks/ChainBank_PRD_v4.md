...
Phase 6 readiness (updated 2026-09-21). Authority remains `tasks/DECISIONS.md`. P6-PREP cleanup is
merged and **Phase 6 is open** — the task tree, reserved identifiers and briefs live in
`tasks/p6-plan.md`.

| Question                                                    | Status         | Resolution                                                                                                                                                                                                    |
| ----------------------------------------------------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Skip Phase 5 (ERC-20) and proceed to Phase 6?               | Resolved (D15) | Skip Phase 5 until a concrete need arises. Phase 6 is next. The Phase 6 adapter stays native-transfer only; tokens are a later extension.                                                                     |
| Keep the C23 hatch into Phase 6, and may it vary per chain? | Resolved (D16) | Hatch remains. Mode is process-global: every chain is hatch, or every chain is two-tier. No per-chain mix without a new decision.                                                                             |
| Has Phase 9 two-tier been cut over on hosted Render?        | Resolved (D17) | Yes. Operator confirmed 2026-08-28 that Public/Private is live on Render. Hosted Phase 9 exit criteria are treated as met on that attestation.                                                                |
| Which chain is Phase 6's second chain?                      | Resolved (D18) | Base Sepolia, EVM chain id 84532, native ETH, block time 2 000 ms. T6.1 (the chain-keyed adapter registry) registers no second chain; Base Sepolia lands in T6.3. Per D16, Base needs a Private treasury too. |
...
| 5 — ERC-20 asset provisioning          | **Deferred (D15, 2026-08-28).** Not cancelled. Resume when a concrete token-provisioning need arises. Phase 6 must not implement ERC-20 methods.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 6 — Multi-chain support                | **Open (D18, 2026-09-21).** Target chain is Base Sepolia (84532). P6-PREP landed (PRs #105, #108–#111; migration `0010`); gates D15–D18 are closed. Dispatch from `tasks/p6-plan.md`: T6.1 registry (C26) → T6.2 multi-chain config (C27) → T6.3 Base Sepolia (C28) → T6.4 per-chain failure isolation (C29) ∥ T6.5 chain surfacing (C30). No migration is expected; the schema is already chain-scoped.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 7–8                                    | Out of scope for this effort.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 9 — Two-tier treasury                  | **Live on Render (D17, 2026-08-28).** Merged as PRs #103 / #104 (migration `0009`, C23–C25). Operator attested hosted Public/Private cutover.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
