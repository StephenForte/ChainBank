...
Phase 6 readiness (updated 2026-09-01). Authority remains `tasks/DECISIONS.md`. P6-PREP cleanup is merged.
...
| 6 — Multi-chain support                | P6-PREP landed (PRs #105, #108–#111; migration `0010`). Gates D15–D17 are closed. T6.1 (chain-adapter registry) is the first Phase 6 task — dispatch from a Phase 6 plan after the Final QA checklist in `tasks/p6-prep-plan.md`, not as leftover cleanup.
