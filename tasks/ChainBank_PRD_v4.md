...
Phase 6 readiness (2026-08-28). Authority remains `tasks/DECISIONS.md`.
...
| 6 — Multi-chain support                | Next engineering phase after the P6-PREP cleanup wave. Gates D15–D17 are closed. Do not start T6.1 (chain-adapter registry) until that wave lands. |
