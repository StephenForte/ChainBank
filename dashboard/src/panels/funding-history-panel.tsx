...
export function FundingHistoryPanel({ loadFundingHistory, token, historyProjectFilter, setHistoryProjectFilter, historyStatusFilter, setHistoryStatusFilter, fundingHistoryState, fundingHistoryError, fundingHistoryTotal, fundingHistory }) {
  return (
